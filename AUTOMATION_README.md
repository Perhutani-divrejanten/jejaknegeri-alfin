...
- **email**: Email portal (akan replace "jejakknegeri@gmail.com")
- **socialHandle**: Handle social media (akan replace "JejakNegeri")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #991B1B → custom)
  - **dark**: Warna gelap hitam (contoh: #450A0A → custom)
...
| `JejakNegeri` | `siteName` (tanpa spaces) |
| `JejakNegeri` | `socialHandle` |
| `jejakknegeri@gmail.com` | `email` |
| `#991B1B` (primary) | Warna primary dari config |
| `#450A0A` (dark) | Warna dark dari config |
| `#3F5F1F` (secondary) | Warna secondary dari config |
